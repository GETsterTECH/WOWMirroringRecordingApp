package com.wowmirroringrecordingapp.screenrecording.ui.services;
...
import com.wowmirroringrecordingapp.screenrecording.controllers.settings.CameraSetting;
...
import com.wowmirroringrecordingapp.screenrecording.ui.services.recording.RecordingService.RecordingBinder;
import com.wowmirroringrecordingapp.screenrecording.ui.utils.CameraPreview;
import com.wowmirroringrecordingapp.screenrecording.ui.utils.MyUtils;
import com.wowmirroringrecordingapp.screenrecording.ui.utils.NotificationHelper;
        ...
        if (paramViewRoot == null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                Notification notification = notificationBuilder.setOngoing(true)
                        ...
                        .setContentTitle("com.wowmirroringrecordingapp.screenrecording.App is running in background")
...
//                                MyUtils.toast(getApplicationContext(), "Streaming Started", Toast.LENGTH_SHORT);
        ...
        mImgLive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                toggleNavigationButton(View.GONE);
                if (!StartScreenMirroringRecording.active) {
                    Intent intent = new Intent(getApplicationContext(), StartScreenMirroringRecording.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//        service.setPackage("com.wowmirroringrecordingapp");
