...
public class GetPermissionResponseData {
    ...
    private String cheakby_watchmen_id = "";
    private String watchmen_varify_date_time = "";
    private String acutal_in_date_time = "";
    ...
    public String getCheakby_watchmen_id() {
        return cheakby_watchmen_id;
    }

    public void setCheakby_watchmen_id(String cheakby_watchmen_id) {
        this.cheakby_watchmen_id = cheakby_watchmen_id;
    }

    public String getWatchmen_varify_date_time() {
        return watchmen_varify_date_time;
    }

    public void setWatchmen_varify_date_time(String watchmen_varify_date_time) {
        this.watchmen_varify_date_time = watchmen_varify_date_time;
    }

    public String getAcutal_in_date_time() {
        return acutal_in_date_time;
    }

    public void setAcutal_in_date_time(String acutal_in_date_time) {
        this.acutal_in_date_time = acutal_in_date_time;
    }
}
