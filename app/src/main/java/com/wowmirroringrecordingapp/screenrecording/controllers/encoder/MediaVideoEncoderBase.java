package com.wowmirroringrecordingapp.screenrecording.controllers.encoder;
...
import com.wowmirroringrecordingapp.screenrecording.controllers.encoder.hw.CodecUtil;
import com.wowmirroringrecordingapp.screenrecording.controllers.encoder.hw.FormatVideoEncoder;
...
//		return format;
    ...
    protected Surface prepare_surface_encoder(final String mime, final int frame_rate, final int bitrate)
        ...
        if (DEBUG)
            Log.i(TAG, String.format("prepare_surface_encoder:(%d,%d),mime=%s,frame_rate=%d,bitrate=%d", mWidth, mHeight, mime, frame_rate, bitrate));
